...
class TwelfthChapterProcessor(
    ...
    fun twelfthChapterAnswers(
        ...
        val fourthChapter = javaLanguage.chapters[11]
    ...
    private fun checkerUserAnswerIfDefaultBehavior(
        ...
        val chapter = language.chapters[11]
    ...
    private fun recordSuccess(
        ...
        chapter.chapterProgress = chapter.chapterProgress + 9.09
    ...
    private fun checkToAddAchive(
        ...
        if (chapter.chapterProgress > 99) {
            if(user.achivesList.stream().filter{ it.name == "endedChapter14"  }.count() == 0L){
                user.achivesList.add(achiveRepo.findByName("endedChapter14"))
