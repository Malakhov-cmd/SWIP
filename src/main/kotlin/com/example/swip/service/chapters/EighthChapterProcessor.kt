...
class EighthChapterProcessor(
    ...
    fun eighthChapterAnswers(
        ...
        val fourthChapter = javaLanguage.chapters[7]
    ...
    private fun checkerUserAnswerIfDefaultBehavior(
        ...
        val chapter = language.chapters[7]
    ...
    private fun recordSuccess(
        ...
        chapter.chapterProgress = chapter.chapterProgress + 8.3
    ...
    private fun checkToAddAchive(
        ...
        if (chapter.chapterProgress > 99) {
            if(user.achivesList.stream().filter{ it.name == "endedChapter8"  }.count() == 0L){
                user.achivesList.add(achiveRepo.findByName("endedChapter8"))
