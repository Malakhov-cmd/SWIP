  ...
  <div class="chapter-level-1">
    <div class="theme-level-1">
      <theme-button theme-name="Назначение обобщенного программирования"
                    path-theme="/language/java/exeption/RecomendationWorkWithExeption" id="java-7-chapter-1-theme"/>
      <theme-button theme-name="Определение простого обобщенного класса"
                    path-theme="/language/java/exeption/RecomendationWorkWithExeption" id="java-7-chapter-2-theme"/>
      <theme-button theme-name="Обобщенные методы"
                    path-theme="/language/java/exeption/RecomendationWorkWithExeption" id="java-7-chapter-3-theme"/>
      <theme-button theme-name="Ограничения на переменные типа"
                    path-theme="/language/java/exeption/RecomendationWorkWithExeption" id="java-7-chapter-4-theme"/>
      <generic-code-and-virtual-machine/>
      <theme-button theme-name="Ограничения и пределы обобщений"
                    path-theme="/language/java/exeption/RecomendationWorkWithExeption" id="java-7-chapter-6-theme"/>
      <theme-button theme-name="Правила наследования обобщенных типов"
                    path-theme="/language/java/exeption/RecomendationWorkWithExeption" id="java-7-chapter-7-theme"/>
    </div>
