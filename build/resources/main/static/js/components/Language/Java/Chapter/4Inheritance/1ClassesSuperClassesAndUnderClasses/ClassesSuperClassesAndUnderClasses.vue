  ...
  <div class="chapter-level-2">
    <div class="theme-level-2">
      <theme-button theme-name="Определение подклассов"
                    path-theme="/language/java/inheritance/DefenitionUnderClasses"
                    id="java-4-chapter-1-theme-1-subtheme"/>
      <theme-button theme-name="Иерархии наследования"
                    path-theme="/language/java/inheritance/HierarchyInheritance"
                    id="java-4-chapter-1-theme-2-subtheme"/>
      <theme-button theme-name="Полиморфизм"
                    path-theme="/language/java/inheritance/Polymorfizm"
                    id="java-4-chapter-1-theme-3-subtheme"/>
      <theme-button theme-name="Предотвращение наследования: конечные классы и методы"
                    path-theme="/language/java/inheritance/PreventionInheritance"
                    id="java-4-chapter-1-theme-4-subtheme"/>
      <theme-button theme-name="Приведение типов "
                    path-theme="/language/java/inheritance/BringingTypes"
                    id="java-4-chapter-1-theme-5-subtheme"/>
      <theme-button theme-name="Абстрактные классы"
                    path-theme="/language/java/inheritance/AbstractClasses"
                    id="java-4-chapter-1-theme-6-subtheme"/>
    </div>
    <chapter-button chapter-name="Классы, суперклассы и подклассы" class="theme-level-4-chapter-left"
                    id="java-4-chapter-1-theme"/>
  </div>
</template>
